...
urlpatterns = [
    ...
    path('announcements/<int:pk>/ack/',  views.AnnouncementAckView.as_view(),        name='announcement-ack'),
    ...
    path('admin/announcements/export/',  views.AnnouncementAdminExportView.as_view(), name='admin-announcements-export'),
    path('admin/announcements/bulk/',    views.AnnouncementBulkView.as_view(),        name='admin-announcements-bulk'),
    ...
    path('admin/announcements/<int:pk>/delivery/export/', views.AnnouncementDeliveryExportView.as_view(), name='admin-announcement-delivery-export'),
