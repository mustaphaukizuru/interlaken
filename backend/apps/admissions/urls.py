...
urlpatterns = [
    ...
    path('register/export/',           RegistrationExportView.as_view(),             name='register-export'),
    ...
    path('register/<int:pk>/documents/list/', views.DocumentListView.as_view(),    name='register-docs-list'),
