...
export default function TopBar({ title, subtitle }: { title: string; subtitle?: string }) {
  ...
  return (
    <>
      {/* 3px accent bar */}
      <div className="h-[3px] flex-shrink-0" style={{ background: 'linear-gradient(90deg, #401a8e 0%, #9a1185 30%, #ef2558 60%, #47a028 100%)' }} />
      <header className="sticky top-[3px] z-20 flex items-center gap-3 border-b border-[#ECEAF3] bg-cream/[0.92] px-4 py-3.5 backdrop-blur-[14px] sm:gap-4 sm:px-6 lg:px-8">
        ...
        {/* Search */}
        <div className="hidden w-[200px] items-center gap-2 rounded-xl border border-[#ECEAF3] bg-white px-3.5 py-[9px] shadow-card md:flex">
        ...
        {/* Bell */}
        <button aria-label="Notificaciones" className="relative flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-[11px] border border-[#ECEAF3] bg-white shadow-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pink/60">
        ...
        {/* Avatar */}
        <div className="flex flex-shrink-0 items-center gap-2.5 rounded-[14px] border border-[#ECEAF3] bg-white py-1.5 pl-3.5 pr-3 shadow-card">
