...
import {
  ArrowRight, Star, Mail, Check, Send, ShieldCheck, Award, Languages, Trophy, Palette, FlaskConical, Heart,
} from 'lucide-react';
...
/**
 * Everything on the home page below the fold (institutional video, testimonios,
 * gallery, lead capture, closing CTA).
 *
 * Split out and lazily mounted so a cold visit downloads the hero + programs
 * first: none of this is visible until the visitor scrolls, and it carries the
 * gallery markup and the lead form that the first paint does not need.
 */
