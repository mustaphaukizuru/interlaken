 ...
 */
export function BulkConfirmDialog({ open, onClose, action, entityLabel, gender = 'f', ids, allMatching = false, filters, payload, execute, onDone }: Props) {
...
function BulkConfirmBody({ action, entityLabel, gender = 'f', ids, allMatching, filters, payload: extraPayload, execute, onDone, onClose }: Omit<Props, 'open' | 'action'> & { action: BulkActionDef }) {
