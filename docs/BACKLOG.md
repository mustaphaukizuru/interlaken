...
| P3-4 | Phase 3: visual editor at `/admin/contenido`: split view, preview token iframe, edit mode (hover outlines, click select, inline text, drag reorder), autosave, publish, schedule, unpublish, version history with diff, rollback, device-width toggle. | DONE 2026-08-22 (core: `/admin/contenido` page list + create/delete, `/admin/contenido/:id` split-view editor: block list with add/reorder/duplicate/remove, registry-generated property forms with media picker, live preview with click-to-select and mobile/tablet/desktop widths, autosave 1.5 s, publish/unpublish, versions + rollback, SEO/slug panel, shareable preview link. Deferred: drag-and-drop, inline text editing, scheduled publish, version diff) |
